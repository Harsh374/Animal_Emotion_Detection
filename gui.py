...
face = cv2.CascadeClassifier(r"C:/Users/harsh/Desktop/Animal_Emotion/haarcascade_frontalface_default.xml")
model = FacialExpressionModel("C:/Users/harsh/Desktop/Animal_Emotion/model_a1.json","C:/Users/harsh/Desktop/Animal_Emotion/model1.weights.h5")

EMOTIONS_LIST = ["Angry","Happy","Relaxed","Sad"]
...
def Detect(file_path):
    ...
    try:
        for (x,y,w,h) in faces:
            ...
            label1.configure(foreground="#011638",text = "Dog " + pred)
